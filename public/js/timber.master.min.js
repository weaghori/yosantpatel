  ...
  var a,
          ...
          ? (A.state(!0),
            ...
            $(c).on(ca, function (a) {
              return (
                ...
                $(c).removeClass("inactive"),
                $(f).removeClass("active"),
                void (ea || $(".header-inner").css({ top: 0 })))
              );
            }))
          : ($(c).removeClass(a + " " + b),
    ...
    x = {
      init: function () {
        ...
        function c(a) {
          $(a).parents().eq(2).is("nav")
            ? $(a).closest(u).find(v).css({ height: 0 }).removeClass("open")
            : $(a).closest("li").find(v).css({ height: 0 }).removeClass("open");
        }
        function d(a, b) {
          $(a)
            .parents(v)
                ...
                return (
                  ...
                  !$(this).siblings(v).data("animating") &&
                    ...
                    $(this).parent().hasClass("current")
                      ...
                      : ($(this).parents().eq(2).is("nav") &&
                          $(u).find("nav").find("li").removeClass("current"),
        ...
        $(G).each(function () {
          ...
          $(H).each(function () {
            $(this).on("click", function () {
              ...
              return (
                $(G).find(a).parent().removeClass("disabled"),
          ...
          a.each(function () {
            ...
            $(M).each(function () {
              $(this).on("click", function () {
                ...
                return (
                  $(I).find(a).parent().removeClass("disabled"),
          ...
          $(this)
            ...
            .each(function () {
              ...
              e.on(b, function (b) {
                ...
                if ($(this).parent().hasClass("disabled")) return !1;
                if (
                  ($(this).parent().hasClass("list-up") &&
                    ((d =
                      $(Q).children(".button, button").outerHeight() +
                      a(c) +
                      8),
                    c.css({
                      transition: "none",
...
!(function (a, b, c, d) {
  ...
  function g(b, c, d, e) {
    ...
    if (
      ...
      if (
        (((b.find(".tm-loader").length && !l) || L) && h(f, b, d),
  ...
  var i = function (d, g) {
      ...
      if (
        ...
        (o.is("[data-nav-dark]") || z.is("[data-nav-dark]")) &&
      ...
      if (i.navPagination && y.children().length > 1) {
        for (
          var F = a("<div>").addClass("tms-pagination").appendTo(o), G = 1;
          G < y.children().length + 1;
          G++
        )
          o.find(F).append(
          ...
          a(this).on("click", function () {
            return (
              ...
              !a(this).hasClass("active") &&
                ...
                parseFloat(F.find(".active").data("index"))
      ...
      (t.initSlideshow = function () {
        return (
          ...
          i.showProgressBar &&
            (R = a("<div>").addClass("tms-progress-bar").appendTo(o)),
          t.startSlideshow(),
          U(i.interval),
          (M = new Date().getTime()),
          (P = i.interval),
          ...
          (a = a ? O : i.interval),
            (K = setInterval(function () {
              a !== i.interval &&
                ...
                (M = new Date().getTime()),
                "undefined" != typeof R &&
                  R.css({ transition: "none", width: "0px" }),
                U(i.interval),
                t.nextSlide();
            }, a));
        }),
      ...
      (t.nextSlide = function () {
        ...
        if (
          ((b = a.inArray(c, B) + 1 === 0 ? 1 : a.inArray(c, B) + 1),
          i.carousel && i.carouselVisible > 1)
        ) {
          var d = q(o, i);
          1 !== d &&
            (b = b === y.children().length - (d - 2) ? 1 : a.inArray(c, B) + 1);
        }
        this.slideTo(b, "next");
      }),
      ...
      try {
        if (b.find("iframe").length) {
          ...
          "undefined" != typeof f && f.indexOf("vimeo") > -1
            ? ((e = $f(a(e)[0])),
              "play" === c && d.autoPlay
                ? (e.api("play"), b.addClass("video-playing"))
                : (e.api("pause"), b.removeClass("video-playing")))
            : "undefined" != typeof f &&
              f.indexOf("youtu") > -1 &&
              ((e = e.replace("#", "")),
              "play" === c && d.autoPlay
                ? (w[e].playVideo(), b.addClass("video-playing"))
                : (w[e].stopVideo(), b.removeClass("video-playing")));
        } else
          b.find("video").length &&
    ...
    z = function (d, e, f, g) {
      ...
      var j = e.closest("li"),
        ...
        m = new Date();
      if (
        (e.attr("id", "video-" + m.getTime()),
        "undefined" != typeof k && k.indexOf("vimeo") > -1)
      ) {
        if (
          (e
            .attr("src", e.attr("src") + "&amp;player_id=" + e.attr("id"))
            .addClass("vimeo"),
          j.is("[data-video-bkg-vimeo]") &&
            e
              .attr(
                "src",
                e.attr("src") +
            ...
            e
              .attr(
                ...
                e.attr("src") +
                  ...
                  e.attr("src").split("embed/")[1].substring(0, 11)
              )
              .addClass("youtube"),
                ...
                onStateChange: function (a) {
                  a.data === YT.PlayerState.PLAYING &&
                    ...
                    a.data === YT.PlayerState.ENDED &&
                      (f.replayOnEnd && w[c].playVideo(),
                      f.nextSlideOnEnd && g.nextSlide());
                },
                onReady: function (a) {
                  i &&
                    f.autoPlay &&
                    (w[c].playVideo(), e.addClass("video-playing")),
        ...
        u &&
          f.autoPlay &&
          (t.load(), (t.autoplay = !0), j.addClass("video-playing")),
          t.addEventListener("playing", function () {
            j.addClass("video-bkg-loaded");
          }),
          (f.muteBkgVideo || j.is("[data-mute-video]")) &&
            (t.muted = f.muteBkgVideo);
      }
    },
    A = (function () {
      var a = {};
...
!(function (a, b, c, d) {
  ...
  var e = function (b, d) {
      ...
      (b = a(b)),
        (e.extraSpaceTop = b.data("extra-space-top")
          ? b.data("extra-space-top")
          : e.extraSpaceTop),
        (e.extraSpaceBottom = b.data("extra-space-bottom")
          ? b.data("extra-space-bottom")
          : e.extraSpaceBottom),
        (e.pushSection = b.data("push-section")
          ? b.data("push-section")
          : e.pushSection),
      ...
      b
        .data("startup", !0)
        .data("orignDistance", g)
        .css({ width: "100%", display: "flex", flexDirection: "column" }),
        h(b, e),
        a(c).on("scroll resize", function () {
          f(b),
            b.data("startup") || h(b, e),
            a(c).width() >= e.breakpoint && i
              ? ((i = !1), (g = b.offset().top), b.data("orignDistance", g))
              : a(c).width() < e.breakpoint && (i = !0);
        }),
...
$(document).ready(function () {
  ...
  var a = ".header",
    ...
    X = "successful, Thank You For Subscribing!",
    ...
    Da =
      ".no-page-fade, .no-page-fade a, .mail-link, .lightbox-link, .contains-sub-menu, .blog .pagination-previous, .blog .pagination-next, .disabled, .scroll-link, .navigation-show a, a.navigation-show",
    Ea =
      "webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend",
    Fa = {
      init: function () {
        ...
        try {
          document.getElementsByClassName("map-canvas") &&
            google.maps.event.addDomListener(window, "load", Fa.googleMap);
        } catch (a) {}
        Fa.fixedFooter(),
          Fa.pageFade(),
          Fa.scrollToSection(),
      ...
      horizon: function (a, b, c, d, e) {
        return (
          ...
          void $(a).not(b).horizon({ easing: c, recurring: d, threshold: e })
        );
      },
      freeze: function (a) {
            ...
            $(l).each(function () {
              ...
              if ($(this).is("[data-width],[data-height]"))
                if ($("body").hasClass("mobile") || c <= 768) {
                  ...
                  (j = g && j <= g ? g : j),
                    a.css({ height: "auto" }),
                    b.css({ height: j + "px", minHeight: j + "px" });
                } else
                  a.removeClass("fs-image-scale"),
                    a.css({ height: "" }),
                    b.css({ height: "", minHeight: "" });
              else
      ...
      scrollToSection: function () {
        ...
        var e = function (a) {
          ...
          f = function (a) {
            var b =
              "header, .header-sub, .side-navigation-wrapper, .overlay-navigation-wrapper";
      ...
      signupForm: function () {
        $(S).submit(function (a) {
          ...
          if (
            ...
            k || (l = !0),
            e.val() && !Fa.isValidEmail(e.val())
              ? (c.hide().text(Z).fadeIn(200), e.addClass(T))
              : (m = !0),
            "" !== f.val())
          )
            return !1;
      ...
      contactForm: function () {
        $(_).submit(function (a) {
          ...
          if (
            ...
            o || (p = !0),
            e.val() && !Fa.isValidEmail(e.val())
              ? (c.hide().text(ga).fadeIn(200), e.addClass(aa))
              : (q = !0),
            "" !== f.val())
          )
            return !1;
              ...
              $(this).on("click", function (a) {
                ...
                d.panTo(f),
                  $(this).data("marker") ||
                    ...
                    $(this).data("marker", !0)),
                  $(this).closest(ia).hasClass(ia.split(".").join("")) &&
                    ($(this).closest(ia).find(".active").removeClass("active"),
                    $(this).addClass("active"));
              });
          });
      },
