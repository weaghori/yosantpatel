...
export default function Header() {
  ...
  const isTransparent = isHomePage || isAbout || isSolutions || isApproach || isContact || isWorkDetail;

  // Pages with dark hero images need the white logo for transparency
  const hasDarkHero = isHomePage || isAbout || isSolutions || isApproach || isContact || isWorkDetail;
