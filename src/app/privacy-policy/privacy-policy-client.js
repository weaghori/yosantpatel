  ...
  return (
    <>
      ...
      <section style={{
        ...
        backgroundImage: 'radial-gradient(circle at 50% 120%, rgba(255, 255, 255, 0.05) 0%, transparent 60%)',
        display: 'flex',
        alignItems: 'center',
        ...
        <div className="row">
          <div className="column width-12">
            ...
            <ul>
              ...
              <li>By visiting this page on our website: https://yosantpatel.com/contact.html</li>
              <li>By phone number: +91 909 909 27 20</li>
              <li>By mail: 204, Vaishali Shopping Centre, Nr. Natraj Market, SV Road, Malad (W), Mumbai.</li>
            </ul>
          </div>
        </div>
      </div>
