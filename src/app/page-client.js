  ...
  return (
    <>
      ...
      <div className="section-block replicable-content" style={{ padding: isMobile ? '60px 0' : '120px 0', backgroundColor: '#ffffff', borderBottom: '1px solid #f1f5f9' }}>
        ...
        {/* Projects Grid Section - Theme Based Creative UI */}
        <div className="row" style={{ marginTop: isMobile ? '60px' : '100px' }}>
          <div style={{
            display: 'grid',
          ...
          <div style={{ textAlign: 'center', marginTop: '60px' }}>
             <Link href="/work">
               <button style={{
                  ...
                  transition: 'all 0.3s ease',
                  outline: 'none',
                  boxShadow: '0 10px 20px -5px rgba(32, 59, 114, 0.4)'
               }}
               onMouseEnter={(e) => {
                 e.currentTarget.style.transform = 'translateY(-3px)';
                 e.currentTarget.style.boxShadow = '0 15px 25px -5px rgba(32, 59, 114, 0.5)';
               }}
               onMouseLeave={(e) => {
                 e.currentTarget.style.transform = 'translateY(0)';
                 e.currentTarget.style.boxShadow = '0 10px 20px -5px rgba(32, 59, 114, 0.4)';
               }}
               >
                  Explore All Work
               </button>
